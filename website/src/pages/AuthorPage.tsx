  ...
  return (
    <article className="max-w-3xl space-y-8">
      ...
      <div className="space-y-5 text-lg leading-8 text-gray-300">
        ...
        <p>
          {lang === "pt-BR" ? "Desenvolve workflows de IA observáveis com LangChain e Langfuse, instrumentando avaliações de LLM e métricas operacionais com Prometheus e Grafana para aumentar a qualidade e a confiabilidade. Foi dessa experiência que surgiu o Wolfpack AI: uma forma mais simples de criar agentes e já deixá-los prontos para produção, com governança eficiente desde o início." : "This developer builds observable AI workflows using LangChain and Langfuse, instrumenting LLM evaluations and operational metrics with Prometheus and Grafana to improve quality and reliability. That experience led to Wolfpack AI: a simpler way to create agents and prepare them for production with efficient governance from the start."}
        </p>
        <p>
