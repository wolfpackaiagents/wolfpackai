      ...
      <section>
        ...
        <div className="p-4 bg-gray-900 border border-gray-800 rounded-xl space-y-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className={`text-xs font-semibold px-2 py-0.5 rounded-full ${example.validationStatus === "passed" ? "text-green-400 bg-green-500/15" : example.validationStatus === "not-verified" ? "text-amber-300 bg-amber-500/15" : "text-amber-400 bg-amber-500/15"}`}>
                {example.validationStatus === "passed" ? (lang === "pt-BR" ? "APROVADO" : "PASSED") : example.validationStatus === "not-verified" ? "BETA" : (lang === "pt-BR" ? "PRECISA DE CORREÇÃO" : "NEEDS REPAIR")}
            </span>
