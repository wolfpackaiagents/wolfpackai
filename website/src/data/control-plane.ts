...
export const controlPlaneSections: SectionContent[] = [
  ...
  { id: "predictions", title: "Predictions", description: "AIPrediction runs in the AMP. Each prediction persists a simulated social graph of typed entities and relationships extracted from the seed material, with evidence quotes. The timeline, interaction links, entity revisions, and agent snapshots provide an auditable record of the simulation. Accuracy scoring compares the forecast against an observed outcome and transitions the run to evaluated status." },
